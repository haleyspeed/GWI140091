...
dir_in = 'C:\\Users\\haley\\Dropbox\\Sync Data Analysis Computers\\Gulf War Project\\Statistics\\Final Spreadsheets'
os.chdir(dir_in)
...
def get_n (data):
	...
	for index, row in data.iterrows():
		...
		if treatment1 in row[factor1] and row[factor2] == 30:
			...
			n3 = n3 + 1  	
		elif treatment4 in row[factor1] and row[factor2] == 30:
			n4 = n4 + 1
	for index, row in data.iterrows():
