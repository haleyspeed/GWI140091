...
file = 'basal_dendrites_100um.csv'
#dir = 'D:\\Dropbox\\Sync Data Analysis Computers\\Gulf War Project\\Statistics\\Final Spreadsheets\\Morphology Analysis - 4 Groups'
#dir = 'C:\\Users\\hspeed\\Dropbox\\Sync Data Analysis Computers\\Gulf War Project\\Statistics\\Final Spreadsheets\\Morphology Analysis - 4 Groups'
dir = 'D:\\Dropbox\\Projects\\Gulf War Project 2015-2018\\Statistics\\Final Spreadsheets\\Morphology Analysis - 4 Groups'
...
def get_desc (file, dir, stats_mean, stats_std, factor, measurement, df_out):
	...
	row4 = {'measurement':df.ix[3,0], factor:df.ix[3,1], 'n':df.ix[3,2], 'mean':df.ix[3,3], 'ste':df.ix[3,4], 'std':df.ix[3,5], '5% CI':df.ix[3,6], '95% CI':df.ix[3,7]}
	...
	df_out = df_out.append(row4, ignore_index=True)
